    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" class="formCadEmpresa" id="formCadEmpresa" method="POST" action="index.php" >
                    <div class="col-lg-6">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="form-group">
                                ...
                                <label>Cnpj: </label>
                                <input class="form-control form-control-lg form-control-borderless"  itemprop="obrEmp" type="text" placeholder=""  id="cnpj" name="cnpj" required maxlength="14"  > 


                                <label>Razao Social: </label>
                                <input class="form-control" placeholder=""  itemprop="obrEmp" value="" id="razao_social" name="razao_social" required maxlength="49"> 
                                <label>Nome Fantasia: </label>
                                <input class="form-control" placeholder=""  itemprop="obrEmp" value="" id="nome_fantasia" name="nome_fantasia" required maxlength="49"> 
                                <label>Alias: </label>
                                <input class="form-control" placeholder="" itemprop="obrEmp" id="alias" value="" name="alias" required maxlength="19">  
                                <label>Endereco: </label>
                                <input class="form-control" placeholder="" itemprop="obrEmp" id="endereco" value="" name="endereco" required maxlength="49"> 
                                <HR>
                                <div class="row "><label >Resposável Técnico</label> </div>

                                <label>Primeiro nome: </label>
                                <input class="form-control" placeholder=""  itemprop="obrEmp" id="surname" value="" name="surname" required maxlength="49">
                                <label>Último nome: </label>
                                <input class="form-control" placeholder="" itemprop="obrEmp" id="givenName" value="" name="givenName" required maxlength="49">
                                <label>Email administrativo: </label>
                                <input class="form-control" id="email" id="email"  itemprop="obrEmp" placeholder="exemplo@empresa.com.br" value="" name="email" required maxlength="49">
                                <div class="row">
                                    <div class="col-sm-6">
                    ...
                    <div class="col-lg-3">
                        <div class="panel panel-default">
                            ...
                            <span class="table-add float-right mb-3 mr-2" >
                                <button type="button" id="btnNewUser"  disabled="true" class="fa fa-plus fa-2x" data-toggle="modal" data-target="#cadastrarUsuariosModal" ></button>
                            </span>
...
<script src="modulos/mod_gNoc/js/cadastro_1.js"></script>
