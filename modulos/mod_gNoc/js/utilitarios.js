$("input[type=password]").keyup(function () {
    ...
    $("#email").keyup(function ()
    {
        ...
        {
            $("#vEmail").removeClass("glyphicon-remove");
            $("#vEmail").addClass("glyphicon-ok");
            $("#vEmail").css("color", "#00A41E");
            //   $("#btnCadastrar").removeClass("disabled");

        } else {
            $("#vEmail").removeClass("glyphicon-ok");
            $("#vEmail").addClass("glyphicon-remove");
            $("#vEmail").css("color", "#FF0004");
            //   $("#btnCadastrar").addClass("disabled");
        }
    });
